 ...
 * Last Modified: RR 08:22 Tue 14 March 2006
 * QVCS Version: $Revision: 1.18 $
 *
 * Read this first
 * ~~~~~~~~~~~~~~~
 ...
 * Requirements
 * ~~~~~~~~~~~~
 *	This script requires PHP version 4.0.x or above.  It has be verified
 ...
 *****************************************************************************/
	...
	//
$TARGET_URLS = array("http://www.neilswartz.com/FormMail",
										 "http://localhost/Work/PHP/FormMail");					// default; no URLs allowed
...
if (!isset($aGetVars["bad_state"]))
{
	...
	?>
		...
		<BODY text='#000000'>
		<DIV align='center'>
		<H1><EM>Form Error</EM></H1>
		<H2>Your form submission failed due to the following reason(s):</H2>
		<P><?php echo nl2br($sErrorMesg); ?></P>
		<UL>
			<?php
				// NMS
