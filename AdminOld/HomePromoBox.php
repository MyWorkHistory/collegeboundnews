...
mysql_select_db($database_CollegeBoundNews, $CollegeBoundNews);
$query_Recordset1 = "SELECT * FROM SiteText WHERE theKey = 'PromoBlock'";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <hr />
  <h2 class="BlueHeaderText">Modify Home Promo Box</h2>
  <hr />

  <table align="center">
    <tr>
      <td  colspan="2" >
        <span class="SmallText">Make changes to the event and the press the Update Button.</span>
      </td>
    </tr>  
    <tr valign="baseline">
      <td valign="top" width="589">
      	<label>
      	<textarea name="Verbiage" id="Verbiage" cols="75" rows="25"><?php echo htmlentities($row_Recordset1['Verbiage'], ENT_COMPAT, 'utf-8'); ?></textarea>
