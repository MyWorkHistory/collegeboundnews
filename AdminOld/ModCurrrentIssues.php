...
mysql_select_db($database_CollegeBoundNews, $CollegeBoundNews);
$query_Recordset1 = "SELECT * FROM SiteText WHERE theKey = 'CurrentIssues'";
...
<table width="1050" cellpadding="2" cellspacing="2">
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <hr />
      <h2 class="BlueHeaderText">Modify Current Issues</h2>
      <hr />
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          <td width="589"><textarea name="Verbiage" id="Verbiage" cols="75" rows="5"><?php echo htmlentities($row_Recordset1['Verbiage'], ENT_COMPAT, 'utf-8'); ?></textarea>
