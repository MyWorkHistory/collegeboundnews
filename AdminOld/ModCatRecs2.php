...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE Categories SET CatDesc=%s, Disabled=%s WHERE CatID=%s",
  ...
  $updateGoTo = "ModCatRecs.php?CatModified=" . $_POST['CatDesc'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_CollegeBoundNews, $CollegeBoundNews);
$query_Recordset1 = sprintf("SELECT * FROM Categories WHERE CatDesc = %s ORDER BY CatDesc ASC", GetSQLValueString($colname_Recordset1, "text"));
...
<table width="1050" cellpadding="2" cellspacing="2">
    ...
    <hr />
    <span class="BlueHeaderText">Modify a Category</span>
    <hr />
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="CatDesc" value="<?php echo htmlentities($row_Recordset1['CatDesc'], ENT_COMPAT, 'utf-8'); ?>" size="75" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right"><strong>Disabled</strong>:</td>
          <td>
          	<input name="Disabled" type="text"  size="2" maxlength="1" value="<?php echo $row_Recordset1['Disabled']; ?>" />
            <br />
            <span class="SmallText">
            	1 = Disabled.&nbsp;&nbsp;0  = Enabled.<br />
              If you disable a Category, that Category and all<br />it's associated links will not appear on the Lnks Page. 
            </span>
          </td>
        </tr>
        <tr valign="baseline">
          <td colspan="2" align="center"><input type="submit" value="Update record" />&nbsp;<input name="btnReset" type="reset" value="Reset" /></td>
        </tr>
      </table>
      <input type="hidden" name="MM_update" value="form1" />
      <input type="hidden" name="CatID" value="<?php echo $row_Recordset1['CatID']; ?>" />
    </form>
    <p>&nbsp;</p>
