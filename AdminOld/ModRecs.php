...
<!-- InstanceBeginEditable name="EditRegion4" -->
      ...
      <?php 
         if ($_GET['ChangedRec'] != "") {
           echo 'Link <font color="red"><em> ' . $_GET['ChangedRec'] . '</em></font> changed.';
         }
      ?>						
...
<table width="1050" cellpadding="2" cellspacing="2">
    ...
    <hr />
    <span class="BlueHeaderText">Modify a Link: Select Link</span>
    <hr />
    	<span class="SmallText">To select a Link click on it's Radio Button.</span>
		  <form action="ModRecs2.php" method="post" id="form1" name="form1">
          ...
          <?php do { ?>
            <tr>
              <td width="500"><?php echo $row_Recordset1['Title']; ?></td>
			        <td align="center"><input type="radio" name="btnRadio" id="btnRadio" value="<?php echo $row_Recordset1["Title"];?>" onclick="SubmitForm()" /></td>
            </tr>
