...
<BLOCKQUOTE>
  ...
  NAME="subscription_type" VALUE="Bulk Orders: 3 Individual subcription for one year at $39 each"
  CHECKED="1"> <B>YES - Bulk order</B>. I want to receive a monthly, printed
  copy of <B>3 COLLEGE BOUND</B> via first class mail, <B>and</B>
  password to access  <B>collegeboundnews.com </B>for
  my personal, non-institutional use only, for <B>one year</B>
  at the  individual subscriber rate of <B>$39 each</B> .</FONT></P>
