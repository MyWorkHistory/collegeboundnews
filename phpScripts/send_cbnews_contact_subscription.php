<HTML>
<HEAD>
  <TITLE>Contact College Bound News Subscription Department</TITLE>
</HEAD>
<BODY BGCOLOR="#ffffff">
		...
		<TR>
			<TD VALIGN="top">
				<?php
					...
					require ("common.php");
					extract($_POST); 
					$body = "\nUSERS FEEDBACK TO CBNEWS SUBSCRIPTION DEPARTMENT  " .
						"\n-------------------------------  " .
...
//					echo ("<br><center><font size=\"+1\" face=\"vernada,Arial,Helvetica\" color=\"blue\">Thank you - Your Information has been sent to College Bound News Subscription Department.</font>");
