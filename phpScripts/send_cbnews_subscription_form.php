  ...
  <TABLE WIDTH="484" ALIGN="center" BORDERCOLOR="#ffcc66" BORDER="1" HEIGHT="400">
			...
			<TD VALIGN="top">
				<?php
					...
					$body = "\nREQUEST FOR SUBSCRIPTION  " .
						...
						"\n--------- Address ---------  " .
            "\ninstitutionname " . stripslashes(quotemeta($institutionname)).
            "\nSchool_Name " . stripslashes(quotemeta($school_name)).
						...
						"\nSubscription Type " . stripslashes(quotemeta($subscription_type)).
      ...
      <!--<FORM METHOD="POST" action="../ShowPassedPHPFields.php"NAME="form1">-->
				 <INPUT TYPE="hidden" NAME="env_report" VALUE="REMOTE_HOST,REMOTE_ADDR,HTTP_USER_AGENT,AUTH_TYPE,REMOTE_USER">
					...
					<INPUT TYPE="hidden" NAME="recipients" VALUE="<?php 
