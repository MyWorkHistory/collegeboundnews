										...
										if(empty($inquirie)) {
											...
											$_ErrorVariable = 1;
												...
												if($inquirie == "Student,Parent and Individual Subscription") 
                                                    {
                                                        echo ("<br><font size=\"+1\" face=\"Arial,Helvetica\" color=\"black\">You Chose  $inquirie.  <br><br>If this is correct click Submit. Otherwise, click Go Back</font>");
                                                        $queryString = "?inquirie=:" . urlencode($inquirie);

										                $url = "indsubscribe.php".$queryString;
                                                    }
                                                 if($inquirie == "Bulk Orders: 2 Non-Institutional use only at rate of $49.00 each") 
                                                    {
                                                        echo ("<br><font size=\"+1\" face=\"Arial,Helvetica\" color=\"black\">You Chose  $inquirie.  <br><br>If this is correct click Submit. Otherwise, click Go Back</font>");
                                                        $queryString = "?inquirie=:" . urlencode($inquirie);

										                $url = "indsubscribe_bulk2.php".$queryString;
                                                    }
                                                 if($inquirie == "Bulk Orders: 3 Non-Institutional use only at rate of $39.00 each") 
                                                    {
                                                        echo ("<br><font size=\"+1\" face=\"Arial,Helvetica\" color=\"black\">You Chose  $inquirie.  <br><br>If this is correct click Submit. Otherwise, click Go Back</font>");
                                                        $queryString = "?inquirie=:" . urlencode($inquirie);

										                $url = "indsubscribe_bulk3.php".$queryString;
                                                    }
