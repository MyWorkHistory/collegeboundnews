...
<TITLE>collegeboundnews.com</TITLE>
</HEAD>
<FRAMESET FRAMEBORDER=0 BORDER=0 FRAMESPACING=0 ROWS="42,86%">
  <FRAME SRC="navframe.html" NAME="navframe.html" MARGINWIDTH=1 SCROLLING=NO NORESIZE>
  <FRAME SRC="<?php echo $_GET['x'] ?>"  MARGINWIDTH=1 NORESIZE>
  <NOFRAMES>
  <BODY>
  ...
  College,university,higher education,college admissions,financial aid,federal aid,grants,scholarships,merit scholarships, college tuition,admissions,counseling,advice,B.A.,accepted,diversity,trends,surveys,test scores,standardized tests,ACT,SAT,advisor,application,applications,campus,enrollment,curriculum,graduation,graduation rates,College Admissions Advisor,529 college savings plans,college essay,freshman,freshmen,high school students,seniors,minority students.
  </BODY>
  </NOFRAMES>
</FRAMESET>
</HTML>
