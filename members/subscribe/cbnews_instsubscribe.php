                     ...
                     <div class="sidebarColumn">
                        ...
                        <div id="thePrintSection" style="display:none">
							...
							<?php
								...
								echo ("<br />");
								echo ("<br />");
								echo ("<i>COLLEGE BOUND<br />");
								echo ("P.O. Box 6526<br />");
								echo ("Evanston, Illinois 60204</i><br /><br />");
								echo ("<br />");
							    echo ("</p>");
	                        ...
	                        <p>
								...
								<br />
								<br />
								<b>As soon as we receive your payment, we will immediately send you a collegeboundnews.com access code.</b>
	                        </p>
                        </div>
                     </div>
					<br />
						...
						if ($credit_card_bool == 1) {
							...
							if($_ErrorVariable == 0) {
								...
								echo '<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >';
									...
									if ($price == 150) {
										echo '<input type="hidden" name="item_name" value="COLLEGE BOUND - collegeboundnews.com access - two year Institutional subscription" />';
...
// Should indent this stuff:
							$queryString = "?firstname=:" . urlencode($firstname) .
								...
								if($_ErrorVariable == 0) {
									...
									echo ("<br />");
			        				echo ("<br />");
									echo ("If the information you entered is incorrect&nbsp;&nbsp;");
									echo ("<label>");
				        			echo ("<input type=\"button\" value=\"Go Back\" ONCLICK=\"self.history.back();\">");
									echo ("</label>");
								}
