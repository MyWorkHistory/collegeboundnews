                  ...
                  <h3>
					...
					?>                     
                     ...
                     <?php
                     	if ('Credit Card' === $subscription_type) {
                     		echo ("<span>");
                     		echo ("3) click \"submit\" to send it to us or Go Back if their is a mistake.");
                     		echo ("</span>");
                     	}
                     ?>
                     ...
                     <div class="sidebarColumn">
                        ...
                        <div id="thePrintSection" style="display:none">
							...
							<?php
								...
								echo ("<br />");
								echo ("This form should only be filled out by an official of the school or college, such as the principal, teacher, guidance officer or admissions officer."); 
								echo ("<br />");
								echo ("<br />");
								echo ("It constitutes a licensing agreement between your institution and COLLEGE BOUND Publications, Inc.");
								echo ("<br />");
								echo ("<br />");
