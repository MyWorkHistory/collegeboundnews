...
<BODY>
<CENTER>
  <FONT SIZE="+1" COLOR="navy" FACE="vernada,courrier,helvetica">1) Verify your information, 2) Make a pyment, 3) click "submit" to send it to us or Go Back if their is a mistake.</FONT>
  <br />
    <br />
  <br />
...
<div id="printableArea">  <!-- This is for the case where the user needs to print something -->
     
<table WIDTH="484" ALIGN="left" BORDERCOLOR="#ffcc66" BORDER="1" class="tblMain">
  <tr>
    <td VALIGN="top"><?php
		require("common.php");
		...
		echo ("<hr><p><font size=\"+1\" face=\"vernada,Arial,Helvetica\" color=\"red\"><b><u>1) Verify Your Information</u></b></font><br>");
		echo ("<center><font size=\"-1\" face=\"Arial,Helvetica\" color=\"teal\"></center>");
...
//					echo ("<input name=\"submit\" type=\"submit\" value=\"Submit\"><font color=\"white\">---------------------</font>");
					echo ("<input type=\"button\" value=\"I made a mistake, go back to prior page\" ONCLICK=\"self.history.back();\">");
				} else {
	...
	<table WIDTH="584" ALIGN="left" BORDERCOLOR="#ffcc66" BORDER="1" class="tblMain">
		<tr>
			<td>
			<?php
				if (empty($subscription_type)) {
					...
					if($subscription_type == 'Credit Card')
					{
						...
						echo '2) Print out and sign some info';
						// $subscription_type is on the page in another location.
		    			// echo ("<br><font size=\"-1\" face=\"Arial,Helvetica\" color=\"maroon\">$subscription_type </font>");
						echo ("<br />");
						echo ("<br />");
						echo '<button onclick="printDiv(\'printableArea\')">Print and sign</button>';
						echo ("<br />");
						echo ("The address to send it to and other details are on the page you will print out");
			            echo '<hr />';
						// The one below prints the whole page.
