...
<script type="text/javascript" src="../Admin/scripts/cssverticalmenu.js">
    ...
    <tr>
          ...
          <ul id="verticalmenu" class="glossymenu">
            <li><a href="../index.html">Home</a></li>
              ...
              <li><a href="#">Edit Links Page</a>
                <ul>
                  <li><a href="../Admin/AddCatRecs.php">Add a Category</a></li>
                  <li><a href="../Admin/ModCatRecs.php">Modify a Category</a></li>
                  <li><a href="../Admin/AddRecs.php">Add a Link</a></li>
                  <li><a href="../Admin/ModRecs.php">Modify a Link</a></li>
                  <li><a href="../Admin/DelRecs.php">Delete a Link</a></li>
                </ul> 
              </li>
            <li><a href="#">Edit Home Page</a>
                <ul>
                  <li><a href="../Admin/HomePageBlock.php">Modify Center Block</a></li>
                  <li><a href="../Admin/HomePromoBox.php">Modify Promo Box</a></li>
                </ul>
            </li>
            <li><a href="../Admin/ModCurrrentIssues.php">Current Issues Text</a></li>
      ...
      <td width="834" valign="top">
        ...
        <!-- TemplateBeginEditable name="EditRegion3" -->
        	...
        	EditRegion3				<!-- TemplateEndEditable -->     </td>
  </tr>
  </table>
