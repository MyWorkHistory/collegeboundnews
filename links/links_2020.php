...
<p>&nbsp;</p>
<p>&nbsp;
</p><table width="590" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="79" valign="top" align="left"></td>
    <td valign="top" align="left">
    	
      <p><font size="+1" face="Times New Roman"><img src="../resources/links/links.gif" width="149" height="19" align="bottom" border="0" naturalsizeflag="3" /></font></p>
      <p>&nbsp;</p>
<!--
      <P><A HREF="http://www.greenesguides.com/" TARGET="_blank"><FONT
       FACE="Arial Black"><IMG SRC="../resources/links/greenesguide.gif"
      WIDTH="325" HEIGHT="19" ALIGN="BOTTOM" BORDER="0" NATURALSIZEFLAG="3"></FONT></A><BR>
        <B><FONT FACE="Times New Roman">More great tips from private
        college counselors Matthew and Howard Greene, longtime College
        Bound advisors.</FONT></B></P>
-->     
     </td>
        ...
        <?php do { ?>
          <tr>
            <td>
              ...
              <?php 
							echo $row_GetAllCaregories['CatDesc']; 
							mysql_select_db($database_CollegeBoundNews, $CollegeBoundNews);
							$query_GetLinks = "SELECT Links.Title,  Links.Description, Links.Link FROM Links WHERE Links.CatID=" . $row_GetAllCaregories['CatID'] . " ORDER BY Links.Title ASC";
							$GetLinks = mysql_query($query_GetLinks, $CollegeBoundNews) or die(mysql_error());
                ...
                <?php do { ?>
                  <tr>
                    ...
                    <td width="400">
                      ...
                      <a href="<?php echo $row_GetLinks['Link']; ?>" target="_top"><?php echo $row_GetLinks['Title']; ?></a><br />
                        <em><?php echo $row_GetLinks['Description']; ?></em>                      
                       </font>                    
                     </td>
                  </tr>
                  <?php } while ($row_GetLinks = mysql_fetch_assoc($GetLinks)); ?>
              </table>
              <br />
              </font>
            </td>
...
<p>&nbsp;
    ...
    <tr>
      <td valign="top" align="center">
        ...
        <a href="links.html">Links/Resources</a>
        </font></p>
